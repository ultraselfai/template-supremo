...
export type OrganizationWhereInput = {
  ...
  allowedFeatures?: Prisma.StringNullableListFilter<"Organization">
  isSandbox?: Prisma.BoolFilter<"Organization"> | boolean
...
export type OrganizationScalarWhereWithAggregatesInput = {
  ...
  allowedFeatures?: Prisma.StringNullableListFilter<"Organization">
  isSandbox?: Prisma.BoolWithAggregatesFilter<"Organization"> | boolean
...
export type OrganizationCreateInput = {
  ...
  allowedFeatures?: Prisma.OrganizationCreateallowedFeaturesInput | string[]
  isSandbox?: boolean
...
export type OrganizationUpdateInput = {
  ...
  metadata?: Prisma.NullableJsonNullValueInput | runtime.InputJsonValue
  allowedFeatures?: Prisma.OrganizationUpdateallowedFeaturesInput | string[]
...
export type OrganizationCreateallowedFeaturesInput = {
  set: string[]
}
...
export type OrganizationUpdateallowedFeaturesInput = {
  set?: string[]
  push?: string | string[]
}
...
export type OrganizationOmit<ExtArgs extends runtime.Types.Extensions.InternalArgs = runtime.Types.Extensions.DefaultArgs> = runtime.Types.Extensions.GetOmit<"id" | "name" | "slug" | "logo" | "metadata" | "allowedFeatures" | "isSandbox" | "createdAt" | "updatedAt", ExtArgs["result"]["organization"]>
...
export type $OrganizationPayload<ExtArgs extends runtime.Types.Extensions.InternalArgs = runtime.Types.Extensions.DefaultArgs> = {
  ...
  objects: {
    ...
    /**
     * Projetos de formulários desta organização (DEC-28)
     */
  ...
  scalars: runtime.Types.Extensions.GetPayloadResult<{
    ...
    name: string
    /**
     * Slug da URL do tenant (ex: "acme" -> decode.app/acme)
     */
    slug: string
    /**
     * URL do logo no R2
    ...
    logo: string | null
    /**
     * Configurações extras do tenant
     */
    metadata: runtime.JsonValue | null
    /**
     * Features ativas para esta organização (DEC-19)
     */
    allowedFeatures: string[]
    /**
     * Se true, é o Decode Lab (acesso a features dev)
     */
    isSandbox: boolean
    createdAt: Date
    updatedAt: Date
...
export interface OrganizationFieldRefs {
  ...
  readonly allowedFeatures: Prisma.FieldRef<"Organization", 'String[]'>
  readonly isSandbox: Prisma.FieldRef<"Organization", 'Boolean'>
